...
class GraphCompiler final {
 public:
  ...
  struct CompilationContext {
    CompilationContext() {}
    CompilationContext(const std::shared_ptr<Graph>& graph, const std::shared_ptr<Scope>& scope, Target target)
  ...
  const std::shared_ptr<Scope>& GetScope() const { return compilation_context_.scope; }

  CompilationContext& GetCompilationContext() { return compilation_context_; }

  void SetCompilationContext(const CompilationContext& context) { compilation_context_ = context; }
 ...
 private:
  ...
  void RemoveInvalidVariables(CompilationContext* context,
  ...
  void InsertBufferHandlers(CompilationContext* context, std::vector<std::unique_ptr<Instruction>>* instructions);

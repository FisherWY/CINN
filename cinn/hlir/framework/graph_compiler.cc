...
//   auto res =
//       GetFuncFromImpl(impl, common::CINNValuePack{cinn_inputs}, tensor_inputs, input_output_nodes, node->id(),
//       target_);
//   return res;
// }
...
//   auto func = lang::LowerVec(GetOrGenFullFuncName(GenOpFuncName(node)), stages, inputs, {}, {}, nullptr,
//   this->target_); VLOG(3) << "The [" << func.size() << "] functions of node [" << node->attrs.node_name << "]
//   are:\n"; for (auto& i : func) {
//     VLOG(3) << i;
//   }
//   return func;
...
//       << "fusion_groups's size must be 0 or equal to groups. Currently fusion_group's size = " <<
//       fusion_groups.size()
